...
const DefensivePlayerDetail = () => {
    const [sortedPlayers, setDefensivePlayers] = useState([]);
    ...
    useEffect(() => {
        ...
        const fetchPlayers = async () => {
            ...
            const sortedPlayers = 
                result.athletes[1].items.sort((a, b) => {
            ...
            setDefensivePlayers(sortedPlayers);
            setLoading(false);
    ...
    return (
        <section className="defensive-players">
            <h2 style={{
                fontSize: '2vw',
                fontWeight: 'bold',
            }}>Defensive Players</h2>
            <ul>
                ...
                {sortedPlayers.map((player, index) => {
                    ...
                    const playerCollege = player.college ? player.college.name : "Unknown";
                    ...
                    return (
                            <Card key={playerId}
                                ...
                                <ListGroup flush>
                                    ...
                                    <ListGroupItem>
                                        College: {playerCollege}  |  Exp: {player.experience.years}
                                    </ListGroupItem>
                                    <ListGroupItem>
...
export default DefensivePlayerDetail;
